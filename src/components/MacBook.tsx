...
const MacBook = () => {
  ...
  return <div className="flex flex-col items-center justify-around bg-white
  p-8">
    <h1 className="2xl:text-4xl xl:text-3xl md:text-2xl font-semibold
    text-gray-800 mb-8">Choose your new MacBook Air.
    </h1>
    <div className="flex">
      ...
      <div className="w-80 h-64 2xl:mb-0 mb-8">
        ...
        md:justify-start">
          {currentMb.colors.map((col, index) => (
            ...
            ${selectedColor ===  index ? "border-2 border-blue-400" :
              'border-transparent'
            }`}
        ...
        <img src={currentMb.icon} alt={`Apple ${currentMb.chip} Icon`} className="
        w-12 h-12 2xl:mb-2 xl:mb-2"/>
